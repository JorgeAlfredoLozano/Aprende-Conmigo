const templateUserBuy = (userName,title,contactar) => {return (`<!DOCTYPE html>
...
<h1 style="margin: 0; color: #010101; direction: ltr; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 40px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Hola, ${userName}</strong></h1>
</td>
</tr>
</table>
...
<div align="center" class="alignment" style="line-height:10px"><img src="https://imgur.com/2YiBxWx.gif" style="height: auto; display: block; border: 0; max-width: 400px; width: 100%;" width="400"/></div>
</td>
</tr>
</table>
</td>
...
<h3 style="margin: 0; color: #8a3c90; direction: ltr; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 18px; font-weight: 400; letter-spacing: normal; line-height: 150%; text-align: center; margin-top: 0; margin-bottom: 0;"><span style="color: #ffffff;">¡Su pago ha sido realizado con éxito! Esperamos que disfrutes mucho del curso ${title} y que te sea de gran provecho en tu   crecimiento profesional. Si tienes alguna consulta o necesitas asistencia adicional, no dudes en contactarnos, estaremos encantados de ayudarte en todo momento.  ¡Gracias por confiar en nosotros!</span></h3>
</td>
</tr>
</table>
...
module.exports = templateUserBuy;
