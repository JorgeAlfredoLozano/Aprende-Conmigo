const templateUserSale = (userName, profName, title, hora, contactar) => {
    return (
    `<!DOCTYPE html>
    ...
    <tr>
    <td>
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; width: 480.00px; margin: 0 auto;" width="480.00">
    <tbody>
    <tr>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #3366ff;" width="100%">
    <tbody>
    <tr>
    <td>
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; width: 480.00px; margin: 0 auto;" width="480.00">
    ...
    <h1 style="margin: 0; color: #010101; direction: ltr; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 40px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Hola, ${profName}</strong></h1>
    </td>
    </tr>
    </table>
    ...
    <div align="center" class="alignment" style="line-height:10px"><img src="https://imgur.com/4hKex1M.gif" style="height: auto; display: block; border: 0; max-width: 400px; width: 100%;" width="400"/></div>
    </td>
    </tr>
    </table>
    </td>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #3366ff;" width="100%">
    <tbody>
    <tr>
    <td>
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; width: 480.00px; margin: 0 auto;" width="480.00">
    ...
    <h3 style="margin: 0; color: #8a3c90; direction: ltr; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 18px; font-weight: 400; letter-spacing: normal; line-height: 150%; text-align: center; margin-top: 0; margin-bottom: 0;"><span style="color: #ffffff;">¡Es un placer informarte que ${userName} acaba de inscribirse en tu curso de ${title}! Hemos recibido con éxito el pago por ${hora} horas . Sabemos que tu dedicación y pasión en la enseñanza son fundamentales para el éxito de nuestros estudiantes, y estamos emocionados de ver cómo más personas se unen a tu clase.</span><br/><br/><span style="color: #ffffff;">¡Gracias por ser un pilar en nuestro equipo educativo y seguir inspirando a más personas a aprender!</span></h3>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td>
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; border-radius: 7px; width: 480.00px; margin: 0 auto;" width="480.00">
    <tbody>
    <tr>
    <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; text-align: left; font-weight: 400; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="66.66666666666667%">
    <div class="spacer_block block-1" style="height:60px;line-height:60px;font-size:1px;"> </div>
    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
    <tr>
    <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
    <div align="left" class="alignment" style="line-height:10px"><img src="https://imgur.com/2uc1BnP.jpg" style="height: auto; display: block; border: 0; max-width: 179.20000000000002px; width: 100%;" width="179.20000000000002"/></div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td class="pad">
    <div style="color:#101112;direction:ltr;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;letter-spacing:2px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
    <p style="margin: 0;"><span style="color: #ffffff;">Necesitas ayuda, Contactanos!! </span></p>
    </div>
    </td>
    </tr>
    </table>
...
module.exports = templateUserSale;