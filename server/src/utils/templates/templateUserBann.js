const templateUserBann=(nombre,contactar)=>{
    return (
        `<!DOCTYPE html>
        ...
        <h1 style="margin: 0; color: #010101; direction: ltr; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 40px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>${nombre}</strong></h1>
        </td>
        </tr>
        </table>
...
module.exports = templateUserBann